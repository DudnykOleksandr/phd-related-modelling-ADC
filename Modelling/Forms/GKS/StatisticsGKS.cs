...
{
    public partial class StatisticsGKS : Form
    {
        GlobalUnit unit;
        ...
        public StatisticsGKS(GlobalUnit unit)
        {
            InitializeComponent();
            this.unit = unit;
        ...
        private void btnCalculate_Click(object sender, EventArgs e)
        {
            ...
            if(ReadFromFields()!=0)
            {
                data = ADCCharacteristicHelper.GetStatisticsOfDiagramOfTransformationGKS(unit, ReadFromFields());
                Draw();
            }
